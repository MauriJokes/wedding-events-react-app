    ...
    return (
        ...
        >
            ...
            >
                ...
                <circle cx="160" cy="35" r="6" stroke="#C4A882" strokeWidth="0.5" opacity="0.5" />
                ...
                {/* Left leaves */}
                <path d="M 95 24 C 91 16 84 12 83 16 C 86 21 92 24 95 24Z" fill="#C4A882" opacity="0.4" />
                <path d="M 95 24 C 91 32 84 36 83 32 C 86 27 92 24 95 24Z" fill="#C4A882" opacity="0.28" />
                <path d="M 130 26 C 126 18 119 15 118 19 C 121 24 127 26 130 26Z" fill="#C4A882" opacity="0.38" />
                <path d="M 130 26 C 126 34 119 37 118 33 C 121 28 127 26 130 26Z" fill="#C4A882" opacity="0.25" />
                ...
                <path d="M 225 24 C 229 16 236 12 237 16 C 234 21 228 24 225 24Z" fill="#C4A882" opacity="0.4" />
                <path d="M 225 24 C 229 32 236 36 237 32 C 234 27 228 24 225 24Z" fill="#C4A882" opacity="0.28" />
                <path d="M 190 26 C 194 18 201 15 202 19 C 199 24 193 26 190 26Z" fill="#C4A882" opacity="0.38" />
                <path d="M 190 26 C 194 34 201 37 202 33 C 199 28 193 26 190 26Z" fill="#C4A882" opacity="0.25" />
        ...
        >
            <div className="mx-auto max-w-sm">
                ...
                <motion.p
                    ...
                    className="font-serif text-2xl font-light tracking-[0.12em] text-[#F0E6D8] sm:text-3xl"
                >
                ...
                >
                    ...
                    ingin mengumumkan Majlis-Majlis penyatuan anakanda kami:
                </motion.p>
